 ...
 *
 */
export const assignTeacherToStudent = async (data) => {
  const res = await new ApiHelper().FetchFromServer(
    ApiRoutes.ASSIGN_TEACHER_TO_STUDENT.service,
    ApiRoutes.ASSIGN_TEACHER_TO_STUDENT.url,
    ApiRoutes.ASSIGN_TEACHER_TO_STUDENT.method,
    ApiRoutes.ASSIGN_TEACHER_TO_STUDENT.authenticate,
    undefined,
    data
  );
  if (!res.isError) {
