...
import CardContainer from '../../containers/CardContainer/index';
import style from './VideoStyle.css';
...
export default class VideoComponent extends Component {
    ...
    componentDidMount() {
        ...
        axios.get("http://localhost:8000/token").then(results => {
    ...
    render() {
        return (
            <CardContainer title={"Video Conference"} icon={"fa fa-video-camera"}>
                <div>
                    ...
                    <div id="controls">
                        ...
                        <div ref="roomControls">
                            <p className="instructions" style={{ marginLeft: '50px' }}>Room Name:</p>
                            <input ref="roomName" id="room-name" style={{ marginLeft: '50px' }} type="text" placeholder="Enter a room name" />
