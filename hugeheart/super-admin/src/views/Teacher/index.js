...
import { getAllTeachers } from "../../methods";
...
class Teacher extends Component {
    ...
    this.setState(
      {
        ...
        skip: ((selectedPage || 1) - 1) * this.state.limit
      },
      () => {
        this.getUsers();
      }
  ...
  handleSelected = async page => {
    ...
    this.props.history.push(`${AppRoutes.TEACHERS}?${querystring}`);
  };
  /**
   *
   */
          ...
          <Card>
            <CardHeader>
              ...
              <Button
                ...
                onClick={() => {
                  this.props.history.push(AppRoutes.ADD_TEACHER);
                }}
              >
